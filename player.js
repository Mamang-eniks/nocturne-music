...
async function initPlayer(client) {
    ...
    try {
        ...
        //   ANDROID: another client in the "direct URL, no decipher" bucket —
        //     worth trying since YouTube's bot-detection treatment differs
        //     unpredictably per client and changes over time independent of us.
